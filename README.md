...
The application uses MySQL as the relational database. Tables are mapped using JPA annotations and automatically managed using Hibernate. The schema follows normalization principles and uses appropriate data types and primary keys.
